...
Dự án bắt đầu là **clone portfolio** theo yêu cầu chủ quán; **v2** chuyển sang **sản phẩm vận hành thật** — marketing cập nhật tin tức, khuyến mãi, thực đơn và xử lý đặt chỗ qua admin `/admin`, không cần commit Git.
...
Tiến độ chi tiết và ghi chú cho AI: [`docs/ROADMAP.md`](./docs/ROADMAP.md)
